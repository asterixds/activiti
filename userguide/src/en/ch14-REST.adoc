...
|===============
|Type|Format
|String|Plain text parameters. Can contain any valid characters that are allowed in URL's. In case of a +XXXLike+ parameter, the string should contain the wildcard character +%+ (properly url-encoded). This allows to specify the intent of the like-search. Eg. '++Tas%++' matches all values, starting with 'Tas'.
...
|===============
|Type|Format
|String|Plain text parameters. In case of a +XXXLike+ parameter, the string should contain the wildcard character +%+. This allows to specify the intent of the like-search. Eg. '++Tas%++' matches all values, starting with 'Tas'.
